...
def index():
	...
	if form.validate_on_submit():
		...
		db_id = subprocess.check_output(["go", "run", "../main.go", url_flag, traversal_flag, depth_flag, keyword_flag, fuzz_flag])
...
def aboutUs():
		# cookie check
	print request.cookies.get('url') #history of cookies in newline delimited format
	print request.cookies.get('traversal')
	print request.cookies.get('depth')		
	print request.cookies.get('keyword')
	print request.cookies.get('fuzz')
